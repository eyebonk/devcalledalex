  ...
  app: {
    head: {
      ...
      link: [
        ...
        { rel: 'preload', as: 'font', type: 'font/ttf', href: '/fonts/Anton-Regular.ttf', crossorigin: 'anonymous' },
        { rel: 'preload', as: 'font', type: 'font/ttf', href: '/fonts/Poppins-Regular.ttf', crossorigin: 'anonymous' },
      ],
    },
  },
})
