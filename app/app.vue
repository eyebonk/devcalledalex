  ...
  '@graph': [
    {
      ...
      'description': 'Frontend engineer specialising in design systems, component libraries, and accessible, high-quality UI for the web',
      'url': SITE,
    ...
    },
    {
      ...
      '@id': `${SITE}/#pixel61`,
      'name': 'pixel61',
      'legalName': 'pixel61 Ltd',
      'url': 'https://pixel61.com/',
      'description': 'Website design and development studio',
    ...
    },
    {
      ...
      '@id': `${SITE}/#bandmeup`,
      'name': 'Band Me Up',
      'url': 'https://bandmeup.com/',
      'description': 'A SaaS product that lets bands build and manage a website to promote their music and gigs',
      'founder': { '@id': `${SITE}/#person` },
    },
    {
      '@type': 'WebSite',
...
<template>
  <div class="tw-flex tw-flex-col tw-h-full tw-w-full tw-bg-gradient-to-b tw-from-blue tw-to-dark-blue tw-relative">
    <a
      href="#main-content"
      class="tw-sr-only focus:tw-not-sr-only focus:tw-absolute focus:tw-top-4 focus:tw-left-4 focus:tw-z-50 focus:tw-bg-pink focus:tw-text-white focus:tw-px-4 focus:tw-py-2 focus:tw-rounded"
    >
      Skip to content
    </a>
    <div class="tw-flex tw-flex-col tw-h-full tw-w-full">
      ...
      <div class="tw-flex tw-flex-col tw-flex-1">
        <main id="main-content" class="tw-flex tw-flex-col tw-flex-1 tw-relative tw-z-10">
          <div class="tw-container tw-py-20 tw-space-y-28">
            <AboutMe />
            <MyExperience />
            <MyProjects />
            <OtherProjects />
